    ...
    >
      ...
      >
        ...
        <div className="flex flex-row justify-between items-center w-full">
          <h1
            className={`  flex-1 text-white capitalize  font-poppins font-semibold ss:text-[72px] text-[52px] ss:leading-[100px] leading-[72px]`}
          >
        ...
        <div>
          <h1
            className={` text-white  capitalize  font-poppins font-semibold ss:text-[68px] text-[52px] ss:leading-[100px] leading-[72px] w-full`}
          >
            Payment Method.
          </h1>
